  ...
  return (
    <form onSubmit={createNewHabitForm} className="w-full flex flex-col mt-6">
      ...
      <input 
        ...
        className="p-4 rounded-lg mt-12 bg-zinc-800 text-white placeholder:text-zinc-400 group-focus:ring-2 group-focus:ring-violet-700 group-focus:ring-offset-2 group-focus:ring-offset-zinc-900"
        autoFocus
        value={title}
      ...
      <button type="submit" className="mt-6 rounded-lg p-4 justify-center flex gap-3 items-center font-semibold bg-green-600 hover:bg-green-500 transition-colors group-focus:ring-2 group-focus:ring-violet-700 group-focus:ring-offset-2 group-focus:ring-offset-zinc-900">
